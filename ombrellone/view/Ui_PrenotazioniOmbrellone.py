...
# Form implementation generated from reading ui file 'lista_ombrelloni.ui'
#
...
class Ui_PrenotazioniOmbrelloneView(object):
...
"background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:1, y2:0, stop:0 rgba(255, 255, 255, 225), stop:1 rgba(255, 255, 255, 227));")
        ...
        self.tW_lista_ombrelloni.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        ...
        self.tW_lista_ombrelloni.setColumnCount(9)
        ...
        self.tW_lista_ombrelloni.horizontalHeader().setDefaultSectionSize(166)
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(255, 255, 255, 140), stop:1 rgba(255, 255, 255, 165));")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Lista Ombrelloni"))
        ...
        item.setText(_translate("MainWindow", "ORARIO"))
