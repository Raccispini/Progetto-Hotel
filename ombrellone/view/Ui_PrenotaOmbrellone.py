...
class Ui_PrenotaOmbrelloneView(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("Prenota Ombrellone")
        MainWindow.resize(661, 256)
        MainWindow.setMinimumSize(QtCore.QSize(661, 256))
        MainWindow.setMaximumSize(QtCore.QSize(661, 256))
        icon = QtGui.QIcon()
        ...
        self.horizontalLayout_5.addWidget(self.sB_sdraie)
