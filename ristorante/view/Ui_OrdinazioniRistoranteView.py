...
class Ui_OrdinazioniRistoranteView(object):
    def setupUi(self, MainWindow):
        ...
        self.pB_Aggiungi = [self.pB_antipasti, self.pB_primi,self.pB_secondi, self.pB_controni, self.pB_bevande, self.pB_frutta, self.pB_dolci]
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cB_pagamento.setItemText(3, _translate("MainWindow", "Addebito"))
