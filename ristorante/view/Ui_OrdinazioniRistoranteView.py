...
class Ui_OrdinazioniRistoranteView(object):
    def setupUi(self, MainWindow):
        ...
        self.LE_tavolo.setEnabled(True)
        self.LE_tavolo.setMinimumSize(QtCore.QSize(70, 0))
        self.LE_tavolo.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.LE_tavolo.setFont(font)
        self.LE_tavolo.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_tavolo.setReadOnly(True)
        self.LE_tavolo.setObjectName("LE_tavolo")
        self.horizontalLayout_2.addWidget(self.LE_tavolo)
        ...
        self.LE_nominativo = QtWidgets.QLineEdit(self.centralwidget)
        self.LE_nominativo.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_nominativo.sizePolicy().hasHeightForWidth())
        self.LE_nominativo.setSizePolicy(sizePolicy)
        self.LE_nominativo.setMinimumSize(QtCore.QSize(400, 0))
        self.LE_nominativo.setMaximumSize(QtCore.QSize(600, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.LE_nominativo.setFont(font)
        self.LE_nominativo.setReadOnly(True)
        self.LE_nominativo.setObjectName("LE_nominativo")
        self.horizontalLayout_3.addWidget(self.LE_nominativo)
        ...
        self.LE_persone.setEnabled(True)
        self.LE_persone.setMinimumSize(QtCore.QSize(75, 0))
        self.LE_persone.setMaximumSize(QtCore.QSize(75, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.LE_persone.setFont(font)
        self.LE_persone.setReadOnly(True)
        self.LE_persone.setObjectName("LE_persone")
        self.horizontalLayout_4.addWidget(self.LE_persone)
        ...
        self.label_9.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(255, 255, 255, 140), stop:1 rgba(255, 255, 255, 165));")
        ...
        self.LE_totale_ordini.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_totale_ordini.sizePolicy().hasHeightForWidth())
        self.LE_totale_ordini.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.LE_totale_ordini.setFont(font)
        self.LE_totale_ordini.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_totale_ordini.setReadOnly(True)
        self.LE_totale_ordini.setObjectName("LE_totale_ordini")
        self.horizontalLayout_8.addWidget(self.LE_totale_ordini)
        ...
        self.LE_coperto.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_coperto.sizePolicy().hasHeightForWidth())
        self.LE_coperto.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.LE_coperto.setFont(font)
        self.LE_coperto.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_coperto.setReadOnly(True)
        self.LE_coperto.setObjectName("LE_coperto")
        self.horizontalLayout_9.addWidget(self.LE_coperto)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_sconto.sizePolicy().hasHeightForWidth())
        self.LE_sconto.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.LE_sconto.setFont(font)
        self.LE_sconto.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_sconto.setObjectName("LE_sconto")
        self.horizontalLayout_10.addWidget(self.LE_sconto)
        ...
        self.LE_totale.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_totale.sizePolicy().hasHeightForWidth())
        self.LE_totale.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.LE_totale.setFont(font)
        self.LE_totale.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_totale.setReadOnly(True)
        ...
        self.LE_totale_per_persona.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LE_totale_per_persona.sizePolicy().hasHeightForWidth())
        self.LE_totale_per_persona.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.LE_totale_per_persona.setFont(font)
        self.LE_totale_per_persona.setAlignment(QtCore.Qt.AlignCenter)
        self.LE_totale_per_persona.setReadOnly(True)
        ...
        self.pB_controni = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.pB_controni.setFont(font)
        self.pB_controni.setObjectName("pB_controni")
        self.gridLayout_3.addWidget(self.pB_controni, 9, 2, 1, 1)
        ...
        self.tW_scontrino_tavolo.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        ...
        self.pB_stampa_scontrino = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.pB_stampa_scontrino.setFont(font)
        self.pB_stampa_scontrino.setObjectName("pB_stampa_scontrino")
        self.horizontalLayout.addWidget(self.pB_stampa_scontrino)
        self.pB_chiudi_tavolo = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.pB_chiudi_tavolo.setFont(font)
        self.pB_chiudi_tavolo.setIconSize(QtCore.QSize(16, 16))
        self.pB_chiudi_tavolo.setObjectName("pB_chiudi_tavolo")
        self.horizontalLayout.addWidget(self.pB_chiudi_tavolo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Checkout tavolo"))
        ...
        self.pB_controni.setText(_translate("MainWindow", "Aggiungi"))
        ...
        self.pB_stampa_scontrino.setText(_translate("MainWindow", "Stampa scontrino"))
        self.pB_chiudi_tavolo.setText(_translate("MainWindow", "Chiudi tavolo"))
